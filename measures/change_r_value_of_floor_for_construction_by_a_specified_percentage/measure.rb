#start the measure
class ChangeRValueOfFloorForConstructionByASpecifiedPercentage < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    #make an argument floor R-value
    r_value_prct_inc = OpenStudio::Ruleset::OSArgument::makeDoubleArgument("r_value_prct_inc",true)
    r_value_prct_inc.setDisplayName("Percentage Change of R-value for Floor Layer of Construction.")
...
ChangeRValueOfFloorForConstructionByASpecifiedPercentage.new.registerWithApplication
