# start the measure
class HeatingCoilsGasPercentChange < OpenStudio::Ruleset::ModelUserScript
    ...
    coils.each do |coil|
      ...
      if coil_capacity_perc_change != 0.0
        if coil.nominalCapacity.is_initialized
          runner.registerInfo("Applying #{coil_capacity_perc_change}x multiplier to #{coil.name.get}.")
          coil.setNominalCapacity(coil.nominalCapacity.get * coil_capacity_perc_change)          
      ...
      if coil_efficiency_perc_change != 0.0
        runner.registerInfo("Applying #{coil_efficiency_perc_change}x multiplier to #{coil.name.get}.")
        if ((coil.gasBurnerEfficiency + coil.gasBurnerEfficiency * coil_efficiency_perc_change * 0.01) <= 1 )
          ...
          runner.registerWarning("#{coil_efficiency_perc_change}x multiplier results in Efficiency greater than 1.")
        end        
      ...
      if coil_parasitic_electric_perc_change != 0.0
        runner.registerInfo("Applying #{coil_parasitic_electric_perc_change}x multiplier to #{coil.name.get}.")
      ...
      if coil_parasitic_gas_perc_change != 0.0
        runner.registerInfo("Applying #{coil_parasitic_gas_perc_change}x multiplier to #{coil.name.get}.")
...
HeatingCoilsGasPercentChange.new.registerWithApplication
